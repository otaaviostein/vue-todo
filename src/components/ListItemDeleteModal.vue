...
function deleteTask() {
  emits('delete-task')
  closeModal()
  dispatchNotification({ title: 'Success!', content: 'Task deleted', type: 'success' });
}
</script>
...
<template>
  <ModalWrapper @closeModal="closeModal">
    ...
    <template v-slot:content>
      <div class="relative py-8 flex-auto px-8">
        <!-- DESCRIPTION -->
        <p class="flex font-medium dark:color-gray-400">
          Please make sure you know what you are doing. This action is
          irreversible.
        </p>
      </div>
    </template>
